<div class="flex gap-x-2 items-center">
    ...
    <p @class([
        ...
        {{ $lastMessage->body != '' ? str($lastMessage?->body)->sanitizeHtml()->replaceMatches('/<\s*(br|\/p|\/div|\/li)\s*>/i', ' ')->stripTags()->squish()->toString() : ($lastMessage->isAttachment() ? '📎 '.__('wirechat::chats.labels.attachment') : '') }}
    </p>
